package org.gra2mol.example.java2astm;
...
public class Java2ASTMTester {
	
	
	static String BASE_PATH = "../Grammar2Model.examples.Java2ASTMModel/";
	static String MODELS_PATH = "./examples/";
	static String[] MODEL_NAMES = new String[]{"ActionLogin","ActionPublicarNoticia","ActionVerNoticia","BeanTablon"};
...
//	}
	...
	private static  Gra2MoLInterpreterLauncher createInterpreter(String modelName) {
		...
		Gra2MoLInterpreterLauncher interpreter = new Gra2MoLInterpreterLauncher(
				new File(BASE_PATH + "files/src/extractASTM.g2m"),
				new File(BASE_PATH + "files/metamodels/astm.ecore"),
				"astm", 
				new File(MODELS_PATH +  modelName + ".output.xmi"),
				"Java", 
				"compilationUnit", 
				new File(MODELS_PATH +  modelName + ".java"));
