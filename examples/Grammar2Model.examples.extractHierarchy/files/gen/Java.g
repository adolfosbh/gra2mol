...
:	TK_0='class' IdentifierGen=Identifier (typeParametersGen+=typeParameters)?
        (TK_1='extends' extendsClass+=type)?
        (TK_2='implements' implementsList+=typeList)?
        classBodyGen+=classBody 
	{
		...
		if($extendsClass != null) {
	        for(Iterator it = $extendsClass.iterator(); it.hasNext(); )  { 
		...
		if($implementsList != null) {
	        for(Iterator it = $implementsList.iterator(); it.hasNext(); )  { 
...
:	TK_0='interface' IdentifierGen=Identifier typeParametersGen+=typeParameters? (TK_1='extends' extendsList+=typeList)? interfaceBodyGen+=interfaceBody 
	{
		// Create return CST Node
	    ...
	    // Create a CST Node
		if($extendsList != null) {
	        for(Iterator it = $extendsList.iterator(); it.hasNext(); )  { 
	            JavaParser.typeList_return r = (JavaParser.typeList_return) it.next(); 
	            if(r != null && r.returnNode != null) {
