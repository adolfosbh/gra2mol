...
:	 designatorSubPartGen+=designatorSubPart ( TK_0='.'  designatorGen+=designator)? 
	{
		// Create return CST Node
		Node designatorReturnNode = CSTFactoryImpl.eINSTANCE.createNode();
		designatorReturnNode.setKind("designator");
	    // Create a CST Node
		if($designatorSubPartGen != null) {
	        for(Iterator it = $designatorSubPartGen.iterator(); it.hasNext(); )  { 
...
designatorSubPart returns [Node returnNode] 
// modified
	: 	 designatorPartGen+=designatorPart (  TK_0='['  exprListGen+=exprList  TK_1=']' |  TK_2='^')* 
	{
		// Create return CST Node
	    ...
	    // Create a CST Node
		if($designatorPartGen != null) {
	        for(Iterator it = $designatorPartGen.iterator(); it.hasNext(); )  { 
		...
		// Returns the Node with CST Leaves/Nodes
		$designatorSubPart.returnNode = designatorSubPartReturnNode;
	}
	;

designatorPart returns [Node returnNode] 
// modified
	: 	 IDGen=ID 
	{
		// Create return CST Node
		...
		// Returns the Node with CST Leaves/Nodes
		$designatorPart.returnNode = designatorPartReturnNode;
	} 
...
// added simpleStatement
	: 	 TK_0='with'  identListGen+=identList  TK_1='do'  statementGen+=statement ( TK_2=';')? 
	{
		// Create return CST Node
