package org.gra2mol.example.antlr;
...
public class AntlrTester {
	...
	static String BASE_PATH = "../Grammar2Model.examples.extractANTLRModel/";
	static String MODELS_PATH = "./examples/";
	static String[] MODEL_NAMES = new String[]{"Java"};
...
//	}
	...
	private static Gra2MoLEnricher createEnricher() {
		...
		return new Gra2MoLEnricher(
				"delphi",
				new File(BASE_PATH + "files/src/ANTLRv3.g"),
				new File(BASE_PATH + "files/gen/ANTLRv3.g"));
	}
	...
	private static  Gra2MoLInterpreterLauncher createInterpreter(String modelName) {
		...
		Gra2MoLInterpreterLauncher interpreter = new Gra2MoLInterpreterLauncher(
				new File(BASE_PATH + "files/src/extractANTLRModel.g2m"),
				new File(BASE_PATH + "files/metamodels/Grammar.ecore"),
				"Grammar", 
				new File(MODELS_PATH +  modelName + ".output.xmi"),
				"ANTLRv3", 
				"grammarDef", 
				new File(MODELS_PATH +  modelName + ".g3"));
